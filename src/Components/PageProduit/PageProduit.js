                ...
                <div className="produit">
                    ...
                    <div className="details">
                        ...
                        <div className="quantityButton">
                            <input className="productQuantity" type="number"/>
